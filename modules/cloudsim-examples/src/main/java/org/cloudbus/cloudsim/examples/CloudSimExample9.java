		...
		Log.printLine("Starting CloudSimExample9...");
	        ...
	        try {
	        	// First step: Initialize the CloudSim package. It should be called
	            	...
	            	for(int i = id; i < taskNums; i++){
	            		Cloudlet cloudletTemp = new Cloudlet(i, length, pesNumber, fileSize, outputSize, utilizationModel, utilizationModel, utilizationModel);
...
/*	            	for(int i = id; i < taskNums; i++){
	            		broker.bindCloudletToVm(cloudletList.get(i).getCloudletId(), vmlist.get(i%4).getId());
	            	}*/
